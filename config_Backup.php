...
return [
    'modules' => [
        ...
        'OnDemand_AnywhereConnect' => 1,
        'OnDemand_BillPayment' => 1,
        'OnDemand_Catalog' => 1,
        'OnDemand_Erp' => 1,
        'OnDemand_Cms' => 1,
        'OnDemand_Core' => 1,
        ...
        'OnDemand_Customer' => 1,
        'OnDemand_Product' => 1,
        'OnDemand_ErrorProduct' => 1,
        'OnDemand_FilterAdmin' => 1,
        'OnDemand_KTCInstallment' => 1,
        'OnDemand_KTCPayment' => 1,
        'OnDemand_OtpVerification' => 1,
        'OnDemand_PartialLogin' => 1,
        'OnDemand_Checkout' => 1,
        'OnDemand_PromoBlog' => 1,
        'OnDemand_QrcodePayment' => 1,
        'OnDemand_Sales' => 1,
        'OnDemand_Search' => 0,
        'OnDemand_ShippingTracking' => 1,
        'OnDemand_Theme' => 1,
        'OnDemand_Wishlist' => 1,
        'Ondemand_ShopbyBase' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'PaySolutions_PsPayments' => 1,
        'Squeezely_Plugin' => 0,
