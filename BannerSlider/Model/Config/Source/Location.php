...
class Location implements ArrayInterface
{
    ...
    const BLOG_CONTENT_TOP = 'blog_category_index.content-top';
    const BLOG_CONTENT_BOTTOM = 'blog_category_index.content-bottom';
    const BLOG_PAGE_TOP = 'blog_category_index.page-top';
    const BLOG_PAGE_BOTTOM = 'blog_category_index.footer-container';
    const CONTENT_TOP = '.content-top';
    const CONTENT_BOTTOM = '.content-bottom';
    const PAGE_TOP = '.page-top';
    const PAGE_BOTTOM = '.footer-container';
        ...
        $options = [
            ...
            [
                ...
                'value' => [
                    [
                        'label' => __('Top of content'),
                        'value' => self::BLOG_CONTENT_TOP
                    ],
                    [
                        'label' => __('Bottom of content'),
                        'value' => self::BLOG_CONTENT_BOTTOM
                    ],
                    [
                        'label' => __('Top of page'),
                        'value' => self::BLOG_PAGE_TOP
                    ],
                    [
                        'label' => __('Bottom of page'),
                        'value' => self::BLOG_PAGE_BOTTOM
                    ]
                ]
            ],
            [
